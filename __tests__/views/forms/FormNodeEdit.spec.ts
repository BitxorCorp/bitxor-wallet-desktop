...
const networkModule = {
    ...
    getters: {
        knowNodes: () => [
            { url: 'http://api-01.us-west-1.0941-v1.bitxor.network:3000', friendlyName: '614084b4', isDefault: true },
            {
                url: 'http://api-01.ap-southeast-1.0941-v1.bitxor.network:3000',
                friendlyName: '08b0274c',
                isDefault: true,
            },
            { url: 'http://api-01.eu-west-1.0941-v1.bitxor.network:3000', friendlyName: 'c44a95bd', isDefault: true },
            { url: 'http://api-02.eu-central-1.0941-v1.bitxor.network:3000', friendlyName: '7a26944a', isDefault: true },
            {
                url: 'http://api-02.ap-northeast-1.0941-v1.bitxor.network:3000',
                friendlyName: '4d08a4d9',
                isDefault: true,
            },
            { url: 'http://api-01.eu-central-1.0941-v1.bitxor.network:3000', friendlyName: 'a08950e0', isDefault: true },
            {
                url: 'http://api-01.ap-northeast-1.0941-v1.bitxor.network:3000',
...
describe('FormNodeEdit', () => {
    ...
    it('successfully add custom node', async () => {
        wrapper.setData({
            formItems: {
                nodeUrl: 'http://api-01.us-west-1.0941-v1.bitxor.network:3000',
        ...
        wrapper.setData({
            formItems: {
                nodeUrl: 'http://dual-001.bitxor.ninja:3000',
                networkType: 'TEST_NET',
                networkHash: 'ACECD90E7B248E012803228ADB4424F0D966D24149B72E58987D2BF2F2AF03C4',
            },
        });
    ...
    it('provide the right choices', async () => {
        await vm.handleInput('http://api-01.us-west-1.0941-v1.bitxor.network:8000');
        expect(vm.customNodeData).toContain('http://api-01.us-west-1.0941-v1.bitxor.network:8000');
    });
});

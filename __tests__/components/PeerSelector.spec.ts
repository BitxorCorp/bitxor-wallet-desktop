    ...
    const networkModule = {
        ...
        getters: {
            ...
            knowNodes: () => [
                ...
                {
                    url: 'http://api-01.eu-west-1.0941-v1.bitxor.network:3000',
                    friendlyName: 'c44a95bd',
                    isDefault: true,
                    networkType: NetworkType.TEST_NET,
                },
                {
                    url: 'http://api-02.eu-central-1.0941-v1.bitxor.network:3000',
                ...
                {
                    url: 'http://api-01.eu-central-1.0941-v1.bitxor.network:3000',
                ...
                {
                    url: 'http://api.experimental.bitxor.network:3000',

 ...
 *
 */
import { TokenDefinitionTransaction, TokenFlags, TokenId } from 'bitxor-sdk';
...
export class ViewTokenDefinitionTransaction extends TransactionView<TokenDefinitionTransaction> {
    /**
     * Displayed items
     */
    protected resolveDetailItems(): TransactionDetailItem[] {
        const tokenId: TokenId = this.transaction.tokenId;
        const divisibility: number = this.transaction.divisibility;
        const tokenFlags: TokenFlags = this.transaction.flags;
        ...
        return [
            ...
            },
            {
                ...
                value: tokenFlags.transferable,
            },
            {
                key: 'table_header_supply_mutable',
                value: tokenFlags.supplyMutable,
            },
            {
                key: 'table_header_restrictable',
                value: tokenFlags.restrictable,
            },
            {
                key: 'estimated_rental_fee',
                value: {
                    amount: this.$store.getters['network/rentalFeeEstimation'].effectiveTokenRentalFee.compact(),
                    color: 'red',
                },
                isToken: true,
            },

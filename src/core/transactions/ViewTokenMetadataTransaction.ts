...
import { TokenMetadataTransaction } from 'bitxor-sdk';
...
export class ViewTokenMetadataTransaction extends TransactionView<TokenMetadataTransaction> {
    /**
     * Displayed items
     */
    protected resolveDetailItems(): TransactionDetailItem[] {
        ...
        return [
            ...
            { key: 'token', value: this.transaction.targetTokenId.toHex() },

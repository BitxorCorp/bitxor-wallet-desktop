 ...
 *
 */
import { Address, AddressAliasTransaction, AliasAction, TokenAliasTransaction, TokenId, NamespaceId } from 'bitxor-sdk';
...
export class ViewAliasTransaction extends TransactionView<TokenAliasTransaction | AddressAliasTransaction> {
    /**
     * Displayed items
     */
    protected resolveDetailItems(): TransactionDetailItem[] {
        ...
        let aliasTarget: Address | TokenId;

...
import { AggregateTransactionInfo, Transaction, TransactionInfo } from 'bitxor-sdk';
...
export abstract class TransactionView<T extends Transaction> {
    ...
    /**
     * Bitxorcore-server genesis block generation epoch adjustment
     */
     ...
     * Displayed items
     * @see {Store.Token}
     * @type {({ key: string, value: string | boolean, | Token }[])}
     */

...
export enum NotificationType {
    ...
    INVALID_NAMESPACE_OR_TOKEN_ID = 'invalid_namespace_or_token_id',
    ...
    TOKEN_ALIAS_NOT_EXIST_ERROR = 'token_alias_not_exist',
    TOKEN_HEX_FORMAT_ERROR = 'token_hex_format_error',
    TOKEN_LIST_NULL_ERROR = 'the_token_to_be_sent_is_empty',
    TOKEN_NAME_NULL_ERROR = 'token_name_can_not_be_null',

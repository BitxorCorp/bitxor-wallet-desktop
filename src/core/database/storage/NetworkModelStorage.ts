 ...
 *
 */
import { NetworkType, NodeInfo, TransactionFees, RoleType } from 'bitxor-sdk';
        ...
        super('networkCache', [
            ...
            },
            {
                ...
                migrate: (from: any) => {
                    ...
                    modified['1DFB2FAA9E7F054168B0C5FCB84F4DEB62CC2B4D317D861F3168D161F54EA78B'] = new NetworkModel(
                        'http://api-01.eu-central-1.096x.bitxor.network:3000',
            ...
            },
            {
                ...
                migrate: (from: any) => {
                    ...
                    modified['6C1B92391CCB41C96478471C2634C111D9E989DECD66130C0430B5B8D20117CD'] = new NetworkModel(
                        'http://api-01.ap-northeast-1.0.10.0.x.bitxor.network:3000/',
                        NetworkType.TEST_NET,
            ...
            },
            {
                ...
                migrate: (from: any) => {
                    ...
                    if (url?.startsWith('http://api-01.us-east-1.0.10.0.x.bitxor.network:3000')) {
                        // update URL and nodeInfo
                        modified['6C1B92391CCB41C96478471C2634C111D9E989DECD66130C0430B5B8D20117CD'] = new NetworkModel(
                            'http://api-01.us-west-1.0.10.0.x.bitxor.network:3000',
                            NetworkType.TEST_NET,
                            '6C1B92391CCB41C96478471C2634C111D9E989DECD66130C0430B5B8D20117CD',
                            networkConfig[NetworkType.TEST_NET].networkConfigurationDefaults,
                            new TransactionFees(3, 0, 1000, 0, 100),
            ...
            {
                description: 'Reset for Bitxor mainet launch.',
                migrate: () => undefined,
            },
        ]);
    }

...
export class TokenConfigurationModelStorage extends VersionedObjectStorage<Record<string, AccountTokenConfigurationModel>> {
    /**
     * Singleton instance as we want to run the migration just once
     */
    public static INSTANCE = new TokenConfigurationModelStorage();

    private constructor() {
        super({
            storageKey: 'tokenConfiguration',
            migrations: [
                {

...
export class NetworkCurrencyModel {
    constructor(
        /**
         * Token id of this currency. This value is optional if the user only wants to provide the
         * token id. This value will be set if it's loaded by rest.
         */
        public readonly tokenIdHex: string | undefined,
        /**
        ...
        /**
         * The ticket name like BXR when namespace fullname is bitxor
         */

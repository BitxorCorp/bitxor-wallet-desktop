...
import { CosignatureQR } from 'bitxor-qr-library';
...
import { QRCode } from 'bitxor-qr-library/index';

@Component({
    components: { TemplateQRAction, TokenAmountDisplay, MaxFeeSelector, TransactionDetails },
})

...
import { QRCodeGenerator, QRCode, QRCodeType } from 'bitxor-qr-library';
...
import { CosignatureSignedTransaction, SignedTransaction, TransactionMapping } from 'bitxor-sdk';

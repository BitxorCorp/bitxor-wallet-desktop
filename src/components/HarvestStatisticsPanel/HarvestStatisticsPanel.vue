<template>
    <div class="top_harvesting_info">
        <div class="top_account_info">
            <div class="harvesting-status" style="border-bottom-left-radius: 0.08rem; border-top-left-radius: 0.08rem;">
                <div class="title">
            ...
            <div class="collected-fees" style="border-bottom-right-radius: 0.08rem; border-top-right-radius: 0.08rem;">
                <div class="title">

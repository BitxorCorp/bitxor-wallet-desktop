<template>
    <div class="top_network_info">
        <div class="top_account_info">
            ...
            <!--<div v-if="isHarvestingEnabled" class="bxr-outline account-info-tile">
                <div class="title">
            ...
            <div v-else class="bxr-outline account-info-tile">
                <div class="title">
            ...
            <div class="account-info-tile" style="border-top-left-radius: 10px;border-bottom-left-radius: 10px;">
                <div class="title">
            ...
            <div class="account-info-tile" style="border-top-right-radius: 10px;border-bottom-right-radius: 10px;">
                <div class="title">

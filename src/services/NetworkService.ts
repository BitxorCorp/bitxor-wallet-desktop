...
import { NetworkConfiguration, NetworkType, RepositoryFactory, RepositoryFactoryHttp } from 'bitxor-sdk';
...
export class NetworkService {
    ...
    private toNetworkConfigurationModel(dto: NetworkConfiguration, networkType: NetworkType): NetworkConfigurationModel {
        ...
        const fromDto: NetworkConfigurationModel = {
            ...
            maxTokenDivisibility: NetworkConfigurationHelpers.maxTokenDivisibility(dto),
            ...
            maxTokenDuration: NetworkConfigurationHelpers.maxTokenDuration(dto),
            ...
            maxTokenAtomicUnits: NetworkConfigurationHelpers.maxTokenAtomicUnits(dto),
            currencyTokenId: NetworkConfigurationHelpers.currencyTokenId(dto),
            harvestingTokenId: NetworkConfigurationHelpers.harvestingTokenId(dto),

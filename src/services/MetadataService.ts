...
export class MetadataService {
    ...
    public metadataTransactionObserver(
        ...
        } else if (metadataType === MetadataType.Token) {
            const tokenId = new TokenId(targetId);
            metadataObservable = metadataTransactionService.createTokenMetadataTransaction(
                deadline,
                networkType,
                targetAddress,
                tokenId,
     ...
     * @param metadataList
     * @param targetId TokenId | NamespaceId
     */
    public static getTokenMetadataByTargetId(metadataList: MetadataModel[], targetId: string) {

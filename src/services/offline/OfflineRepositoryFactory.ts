import {
    ...
    RestrictionTokenHttp,
    RestrictionTokenRepository,
    SecretLockHttp,
...
import { OfflineTokenRepository } from '@/services/offline/OfflineTokenRepository';
...
export class OfflineRepositoryFactory implements RepositoryFactory {
    ...
    createTokenRepository(): TokenRepository {
        return new OfflineTokenRepository();
    }
    ...
    createRestrictionTokenRepository(): RestrictionTokenRepository {
        ...
        return new RestrictionTokenHttp(OfflineUrl);
    }

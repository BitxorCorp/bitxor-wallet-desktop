...
import { AccountType } from 'bitxor-sdk';
import { SupplementalPublicKeys } from 'bitxor-sdk';
...
export const OfflineNetworkProperties = {
    [NetworkType.TEST_NET]: new NetworkConfiguration(
        ...
        new ChainProperties(
            true,
            true,
            '0x' + networkConfig[NetworkType.TEST_NET].networkConfigurationDefaults.currencyTokenId,
            '0x' + networkConfig[NetworkType.TEST_NET].networkConfigurationDefaults.harvestingTokenId,
            ...
            `${networkConfig[NetworkType.TEST_NET].networkConfigurationDefaults.maxTokenAtomicUnits}`,
            "10'000'000'000",
            "50'000'000'000'000",
            "3'000'000'000'000",
            '720',
    ...
    [NetworkType.MAIN_NET]: new NetworkConfiguration(
        ...
        new ChainProperties(
            true,
            true,
            '0x' + networkConfig[NetworkType.MAIN_NET].networkConfigurationDefaults.currencyTokenId,
            '0x' + networkConfig[NetworkType.MAIN_NET].networkConfigurationDefaults.harvestingTokenId,
            ...
            "7'831'975'436'000'000",
            "9'000'000'000'000'000",
            `${networkConfig[NetworkType.MAIN_NET].networkConfigurationDefaults.maxTokenAtomicUnits}`,
            "10'000'000'000",
            "50'000'000'000'000",
            "3'000'000'000'000",
            "3'000'000'000'000",
...
export const OfflineNetworkCurrencies = (networkType: NetworkType): NetworkCurrencies => {
    const publicCurrency = new Currency({
        ...
        supplyMutable: false,
        restrictable: false,
        tokenId: new TokenId(networkConfig[networkType].networkConfigurationDefaults.currencyTokenId),
    });

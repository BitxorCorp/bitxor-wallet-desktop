...
import { NetworkType, NodeInfo, RepositoryFactory } from 'bitxor-sdk';
...
import { Configuration, NodeApi, NodeListFilter, NodeInfo as NodeApiNodeInfo } from 'bitxor-datanet-service-typescript-fetch-client';

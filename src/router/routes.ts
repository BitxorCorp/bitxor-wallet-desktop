        ...
        children: [
            ...
            },
            {
                ...
                meta: {
                    protected: true,
                    clickable: true,
                    title: 'sidebar_item_tokens',
                    icon: officialIcons.token,
                },
                // @ts-ignore
                component: () => import('@/views/pages/tokens/TokensDashboardPage/TokensDashboardPage.vue'),
                children: [
                    {
                        path: '/tokenList',
                        name: 'token.list',
                        meta: {
                            protected: true,
                            title: 'page_title_tokens',
                        },
                        // @ts-ignore
                        component: () => import('@/views/pages/tokens/TokenListPage/TokenListPage.vue'),
                    },
                    {
                        path: '/tokenCreateDash',
                        name: 'token.createdash',
                        meta: {
                            protected: true,
                            title: 'page_title_tokens_create',
                        },
                        // @ts-ignore
                        component: () => import('@/views/pages/tokens/CreateTokenPage/CreateTokenPagePre.vue'),
                        children: [
                            {
                                path: '/tokenCreate',
                                name: 'token.create',
                                ...
                                // @ts-ignore
                                component: () => import('@/views/pages/tokens/CreateTokenPage/CreateTokenPage.vue'),
                            },
                            {
                                path: '/nftCreate',
                                name: 'nft.create',
                                ...
                                // @ts-ignore
                                component: () => import('@/views/pages/tokens/CreateTokenPage/CreateNftPage.vue'),
                            },
                            {
            ...
            },
            {
                ...
                children: [
                    ...
                    {
                        path: '/aggregate/token',
                        name: 'aggregate.token',
                        meta: {
                            protected: true,
                            title: 'token_transaction',
                        },
                        // @ts-ignore
                        component: () => import('@/views/pages/aggregate/aggregateTransaction/AggregateTransaction.vue'),
                    },
                    {
                        ...
                        meta: {
                            protected: true,
                            title: 'token_supply_transaction',
                        },
                        // @ts-ignore
                        component: () => import('@/views/pages/aggregate/aggregateTransaction/AggregateTransaction.vue'),
                    },

...
import { AccountInfo, AccountNames, Address, IListener, MultisigAccountInfo, PublicAccount, RepositoryFactory } from 'bitxor-sdk';
import Vue from 'vue';
    ...
    actions: {
        ...
        async SET_CURRENT_SIGNER(
            ...
            if (reset) {
                ...
                dispatch('token/LOAD_TOKENS', {}, { root: true });
            } else {
            ...
            dispatch('token/SIGNER_CHANGED', {}, { root: true });
        ...
        async NETWORK_CHANGED({ dispatch }) {
            ...
            dispatch('token/RESET_TOKENS', {}, { root: true });
            dispatch('transaction/LOAD_TRANSACTIONS', undefined, { root: true });
            await dispatch('token/LOAD_NETWORK_CURRENCIES', undefined, {
                root: true,
            });
            await dispatch('LOAD_ACCOUNT_INFO');
            dispatch('namespace/LOAD_NAMESPACES', {}, { root: true });

 ...
 *
 */
import { Address, NamespaceId, RepositoryFactory } from 'bitxor-sdk';
import Vue from 'vue';
    ...
    mutations: {
        ...
        namespaces: (
            ...
            const uniqueNamespaces = _.uniqBy(namespaces, (n) => n.namespaceIdHex).map((namespace) => {
                namespace.metadataList = MetadataService.getTokenMetadataByTargetId(metadatas, namespace.namespaceIdHex);
                return namespace;
            });

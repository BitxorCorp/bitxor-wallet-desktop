...
import { Address, Deadline, MetadataType, Transaction, UInt64 } from 'bitxor-sdk';
...
export default {
    ...
    getters: {
        ...
        tokenMetadataList: (state: MetadataState) => state.tokenMetadataList,
    ...
    mutations: {
        ...
        metadataList: (state: MetadataState, metadataList: MetadataModel[]) => {
            ...
            Vue.set(
                state,
                'tokenMetadataList',
                uniqueMetadataList.filter((metadata) => metadata.metadataType === MetadataType.Token),
            );
            Vue.set(
                state,
                'namespaceMetadataList',

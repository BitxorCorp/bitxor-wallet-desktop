...
import { Account, NetworkType, Password, Crypto, Address } from 'bitxor-sdk';
...
import { BitxorPaperWallet, IAccountInfo, IHDAccountInfo } from 'bitxor-paper-wallets';
...
export class ModalBackupProfileTs extends Vue {
    ...
    protected async generateAndDownloadPaperWallet(): Promise<boolean> {
        ...
        const paperWallet = new BitxorPaperWallet(
            rootAccountInfo,

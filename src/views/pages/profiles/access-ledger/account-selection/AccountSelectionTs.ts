...
import { AccountInfo, Address, TokenId, PublicAccount, NetworkType, RepositoryFactory } from 'bitxor-sdk';
    ...
    private async initAccounts() {
        try {
            ...
            if (repositoryFactory) {
                ...
                this.addressBalanceMap = {
                    ...this.mapBalanceByAddress(undefined, this.networkToken, this.addressesList),
                };
                return;
            }
        } catch (error) {

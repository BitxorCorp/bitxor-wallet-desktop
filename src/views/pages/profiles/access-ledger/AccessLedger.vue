        ...
        <div class="explanation-box">
            <div class="text-wrapper">
                                                ...
                                                <div class="table-item-content">
                                                    ...
                                                    <div class="row balance-row">
                                                        <div class="row">
                                                            <span class="address-balance">{{ $t('balance') }}: </span>
                                                            <span
                                                                v-if="addressTokenMap[optInAddressesList[index].address.plain()]"
                                                                class="address-balance"
                                                            >
                                                                <TokenAmountDisplay
                                                                    :absolute-amount="
                                                                        addressTokenMap[optInAddressesList[index].address.plain()]
                                                                    "
                                                                />
                                                            </span>
                                                            <span v-else class="address-balance">
                ...
                <div v-if="getCurrentStep() === 2">
                    <img src="@/views/resources/img/icons/incoming.png" style="width: 30%;" />

        ...
        <div class="explanation-box">
            <div class="text-wrapper">
                                                ...
                                                <div class="table-item-content">
                                                    ...
                                                    <div class="row balance-row">
                                                        <div class="row">
                                                            ...
                                                            <span
                                                                v-if="addressTokenMap[addressesList[index].plain()]"
                                                                class="address-balance"
                                                            >
                                                                <TokenAmountDisplay
                                                                    :absolute-amount="addressTokenMap[addressesList[index].plain()]"
                                                                />
                                                            </span>
                                                ...
                                                <div class="table-item-content">
                                                    ...
                                                    <div class="row balance-row">
                                                        <div class="row">
                                                            <span class="address-balance">{{ $t('balance') }}: </span>
                                                            <span
                                                                v-if="addressTokenMap[optInAddressesList[index].plain()]"
                                                                class="address-balance"
                                                            >
                                                                <TokenAmountDisplay
                                                                    :absolute-amount="addressTokenMap[optInAddressesList[index].plain()]"
                                                                />
                                                            </span>
                                                            <span v-else class="address-balance">
                                                                0
                ...
                <div v-if="getCurrentStep() === 3">
                    <img src="@/views/resources/img/icons/incoming2.png" style="width: 30%;" />
        ...
        <div class="form-box">
            <div class="steps">
                <div class="step-group">
                     <div style="margin: auto; float: left; vertical-align: middle; display: flex;justify-content: center;padding: 0.44rem 0.44rem;">
                <img src="@/views/resources/bitxor_logo.png" class="logo-container logo-img" style="height: 1rem;" />
            </div>    

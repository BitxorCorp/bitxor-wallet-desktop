...
import { MnemonicQR, QRCodeGenerator } from 'bitxor-qr-library';
// @ts-ignore
import failureIcon from '@/views/resources/img/monitor/failure.png';
import { Password } from 'bitxor-sdk';
import { IHDAccountInfo, BitxorPaperWallet } from 'bitxor-paper-wallets/index';
...
export default class ShowMnemonicTs extends Vue {
    ...
    public async processDownload() {
        ...
        const paperWallet = new BitxorPaperWallet(rootAccountInfo, [], this.currentProfile.networkType, this.currentProfile.generationHash);

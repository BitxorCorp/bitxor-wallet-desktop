    ...
    <div class="create-profile-wrapper radius">
                        ...
                        <div class="right-hints-section">
                            ...
                            <p class="text">
                                <span class="subtitle-info">
                                    <img src="@/views/resources/img/icons/warning.png" class="warning-icon" />
        ...
        <div class="form-box">
           ...
           <div style="margin: auto; float: left; vertical-align: middle; display: flex;justify-content: center;padding: 0.44rem 0.44rem;">
            ...
            </div>        <div v-for="(text, index) in StepBarTitleList" :key="index" :class="['single-step', getStepClassName(index)]">
                        {{ $t(text) }}
                    </div>
                </div>
            </div>

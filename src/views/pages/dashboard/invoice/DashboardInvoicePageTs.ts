...
import { Address, NetworkType, TransferTransaction } from 'bitxor-sdk';
import { TokenAttachment } from '@/views/forms/FormTransferTransaction/FormTransferTransactionTs.ts';
// child components
// @ts-ignore
...
export class DashboardInvoicePageTs extends Vue {
    ...
    /**
     * The transaction's tokens to be displayed
     * @type {TokenAttachment[]}
     */
    get balanceEntries(): TokenAttachment[] {
        if (!this.transactionEntry) {
            return [];
        }

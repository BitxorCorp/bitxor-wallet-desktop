                            ...
                            >
                                <span v-if="title" class="img_container">
                                    <img
                                        ...
                                        src="@/views/resources/img/icons/transactions.png"
                                        alt
                                    />
                                    <img
                                        v-else-if="title.indexOf(`${$t('token_transaction')}`) !== -1"
                                        src="@/views/resources/img/icons/token.png"
                                        alt
                                    />
                                    <img v-else src="@/views/resources/img/icons/namespace.png" alt />
                                </span>
                                <span class="transfer_name">{{ title }}</span>
                                <button class="remove_button" @click="onClickDelete(title)">
                                    <img src="@/views/resources/img/icons/bin.png" alt />
                                </button>
                            </div>
                        </div>

...
import { AliasAction, AliasTransaction, NamespaceId, NamespaceRegistrationTransaction, NamespaceRegistrationType, TokenAliasTransaction, Transaction, UInt64,TokenId,} from 'bitxor-sdk';
...
// @ts-ignore
import NamespaceSelector from '@/components/TokenNewSelector/TokenNewSelector.vue';
// @ts-ignore
...
export class FormNamespaceRegistrationTransactionTs extends FormTransactionBase {
    ...
    protected resetForm() {
        ...
        this.formItems.tokenId = '';
        this.formItems.duration = this.duration;
    ...
    protected getTransactions(): Transaction[] {
        ...
        let namespacereg = NamespaceRegistrationTransaction.createRootNamespace(
            deadline,
        ...
        if (NamespaceRegistrationType.RootNamespace === this.formItems.registrationType) {
            return [
               ...
               TokenAliasTransaction.create(
                ...
                new TokenId(this.formItems.tokenId),
                this.networkType,
                maxFee,

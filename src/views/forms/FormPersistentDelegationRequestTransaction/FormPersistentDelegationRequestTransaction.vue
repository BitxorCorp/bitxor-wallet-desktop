<template>
    <div class="form-persistent-delegation-request">
            ...
            <ValidationObserver v-slot="{ handleSubmit }" ref="observer" slim>
                <form onsubmit="event.preventDefault()">
                    ...
                    <div v-if="activePanel === 1">
                        ...
                        <div class="key-item">
                            <FormRow>
                                <template v-slot:label> {{ $t('linked_voting_public_key') }} 1: </template>
                                <template v-slot:inputs>
                                    <AccountPublicKeyDisplay
                                        v-if="isVotingKeyLinked(0)"
                                        :public-key="currentSignerAccountInfo.supplementalPublicKeys.voting[0].publicKey"
                                    />
                                    <Tooltip
                                        v-else
                                        class="linked-label"
                            ...
                            <img
                                ...
                                :src="linkIcon"
                                class="button-icon"
                                @click="handleSubmit(onSingleKeyOperation('voting', 0))"
                            />
                            <Tooltip v-else word-wrap placement="bottom" :content="$t('label_unlink_vrf_account_public_key')">
                                <Icon
                                    type="md-trash"
                        ...
                        <div v-if="isVotingKeyLinked(0)" class="key-item">
                            <FormRow>
                                <template v-slot:label> {{ $t('linked_voting_public_key') }} 2: </template>
                                <template v-slot:inputs>
                                    <AccountPublicKeyDisplay
                                        v-if="isVotingKeyLinked(1)"
                                        :public-key="currentSignerAccountInfo.supplementalPublicKeys.voting[1].publicKey"
                                    />
                                    <Tooltip
                                        v-else
                                        class="linked-label"
                            ...
                            <img
                                ...
                                :src="linkIcon"
                                class="button-icon"
                                @click="handleSubmit(onSingleKeyOperation('voting', 1))"
                            />
                            <Tooltip v-else word-wrap placement="bottom" :content="$t('label_unlink_vrf_account_public_key')">
                                <Icon
                                    type="md-trash"
                        ...
                        <div v-if="isVotingKeyLinked(1)" class="key-item">
                            <FormRow>
                                <template v-slot:label> {{ $t('linked_voting_public_key') }} 3: </template>
                                <template v-slot:inputs>
                                    <AccountPublicKeyDisplay
                                        v-if="isVotingKeyLinked(2)"
                                        :public-key="currentSignerAccountInfo.supplementalPublicKeys.voting[2].publicKey"
                                    />
                                    <Tooltip
                                        v-else
                                        class="linked-label"
                            ...
                            <img
                                ...
                                :src="linkIcon"
                                class="button-icon"
                                @click="handleSubmit(onSingleKeyOperation('voting', 2))"
                            />
                            <Tooltip v-else word-wrap placement="bottom" :content="$t('label_unlink_vrf_account_public_key')">
                                <Icon
                                    type="md-trash"
        ...
        <ModalImportPublicKey
            :visible="showModalPublicKey"
            :title="modalImportKeyTitle"
            @close="showModalPublicKey = false"
            @submit="onSubmitPublicKey"
            @confirmed="showModalPublicKey = false"
        />
